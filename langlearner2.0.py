def language_learning(level, format_option):
    ...
    if level == '1':
        ...
        if format_option == 'flashcards':
            print("You will be learning basic greetings and verbs!")
            ...
            for i in level_one_verbs:
                ...
                print("--------------")
            print()
            print("Congratulations! You have finished learning all of the vocabulary for level 1!")
        elif format_option == 'test':
            starred = {}
            print("You will be tested on basic greetings and verbs!")
            print("First, we will start off with basic greetings!")
            print("~~~~~~~~~~~~~~")
            ...
            print("Great, let's move on to the verbs!")
            print("~~~~~~~~~~~~~~")
            print("Before we begin, please note two important points:")
            ...
            if len(starred) > 0:
                ...
                while len(starred) > 0:
                    ...
                    for m in range(0, len(correct_on_retry)):
                        starred.pop(correct_on_retry[m])
            print("Congratulations! You have finished testing yourself on all of the vocabulary for level 1!")
    elif level == '2':
        print("Welcome to Spanish Level 2!")
        if format_option == 'flashcards':
            print("You will be learning nouns and adjectives!")
            ...
            for i in level_two_adjective:
                ...
                print("--------------")
            print()
            print("Congratulations! You have finished learning all of the vocabulary for level 2!")
        elif format_option == 'test':
            starred = {}
            print("You will be tested on nouns and adjectives!")
            print("First, we will start off with nouns!")
            print("~~~~~~~~~~~~~~")
            print("Before we begin, please note two important points:")
            ...
            if len(starred) > 0:
                ...
                while len(starred) > 0:
                    ...
                    for m in range(0, len(correct_on_retry)):
                        starred.pop(correct_on_retry[m])
            print("~~~~~~~~~~~~~~")
            print("Great, let's move on to the adjectives!")
            print("~~~~~~~~~~~~~~")
            ...
            if len(starred) > 0:
                ...
                while len(starred) > 0:
                    ...
                    for m in range(0, len(correct_on_retry)):
                        starred.pop(correct_on_retry[m])
            print("Congratulations! You have finished testing yourself on all of the vocabulary for level 2!")
    print("You can restart to program to continue on your Spanish learning journey!")
...
while level != '1' and level != '2':
    ...
    level = input("Which level would you like to try? ")
print("Great, you have two options on how you would like to proceed:")
print("- To learn the vocabulary from level", level, "(type 'flashcards')")
print("- To test yourself on the vocabulary from level", level, "(type 'test')")
format_option = input("Which format would you like? ")
while format_option != 'flashcards' and format_option != 'test':
    print("I'm sorry, but", format_option, "is not a format option for this application!")
    level = input("Which format would you like? ")
print("~~~~~~~~~~~~")
language_learning(level, format_option)
